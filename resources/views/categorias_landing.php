...
<head>
    ...
    <meta name="description" content="Recetas de reposteria, gelatinas, empanadas y más">
    <meta name="keywords" content="como hacer pasteteles, gelatinas saludables, como hacer empanadas, que hacer para comer">
    ...
    <div class="modal-dialog"  ng-repeat="receta in recetaElegida">
        ...
        <div class="modal-content" >
            <div class="modal-header">
                ...
                <img ng-src="{{receta.portada}}" class="img-circle img-responsive" width="304" height="236" style="margin-left:22%;">
