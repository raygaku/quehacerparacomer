...
<head>
    ...
    <meta name="description" content="Guarda tus recetas para que después puedas cocinarlas">
    <meta name="keywords" content="que hacer para comer, recetario gratis,comer sano , guardar recetas gratis , postres deliciosos">
    ...
    <script src="scripts/angular/modules/misrecetas-module.js"></script>
...
<div class="row">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4" ng-repeat="rec in misrecetasson">
            <div class="thumbnail">
